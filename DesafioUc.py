...
cursorBD.execute(''' CREATE TABLE PROYECTOUC(ID INTEGER PRIMARY KEY AUTOINCREMENT,FIRST_NAME TEXT,LAST NAME TEXT,EMAIL TEXT,GENDER TEXT,PLAN DE SALUD TEXT,PHONE INTEGER )''')